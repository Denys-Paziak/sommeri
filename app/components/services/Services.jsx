                ...
                >
                  <div className={styles.services__card_info}>
                    ...
                    <div className={styles.services__info_inner}>
                      ...
                      <p className={styles.services__inner_text}>
                        Our original design emphasizes excellent functionality
                        and high performance, ensuring that your website meets
                        your unique needs and provides an unrivaled.
                      </p>
                    </div>
                  </div>
