            ...
            <div className="container">
                <div className={styles.services__wrapper}>
                    ...
                    <div className={styles.services__wrapper_main}>
                        <AnimBorder className={styles.services__card_secondary} type={"static"}>
                            <div
                            ...
                            >
                                ...
                                <svg className={styles.services__card_image} width="180" height="180"
                        ...
                        <AnimBorder className={styles.services__card_primary} type={"static"}>
                            <div
                                className={`${styles.services__main_card}`}
                            ...
                            >
                                ...
                                <svg className={styles.services__card_image} width="182" height="182"
                                     viewBox="0 0 182 182"
                                     fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path ref={addToRefs} fill-rule="evenodd" clip-rule="evenodd"
