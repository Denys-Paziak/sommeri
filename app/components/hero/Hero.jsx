...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            startLineAnim(lines[12], 3);
            startLineAnim(lines[13], 0);
        }, 19000);
            ...
            <section className={styles.hero__section}>
                ...
                <div className="container">
                    <div className={styles.hero__wrapper}>
                        ...
                        <MouseParallaxChild className={styles.hero__wrapper_code} factorX={0.5} factorY={0.8}>
                    ...
                    >
                        <defs>
                            ...
                            <linearGradient
                                ...
                                y2="100%"
                            >
                                <stop offset="0%" style={{stopColor: "#52b69a"}}/>
                                <stop offset="49.5%" style={{stopColor: "#2697a8"}}/>
                                <stop offset="100%" style={{stopColor: "#168aad"}}/>
                            </linearGradient>
                        </defs>
