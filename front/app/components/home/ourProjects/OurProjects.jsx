...
const OurProjects = () => {
    ...
    return (<section className={styles.projects__section}>
                    ...
                    >
                        <Masonry  gutter="50px">
                            {projects.map((project, index) => {
                                ...
                                return <Link className={projectStyle} href={'/project/' + project.id}>
                                    <div key={project.id} className={styles.project__portfolio_item}>
