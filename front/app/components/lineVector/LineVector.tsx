...
const LineVector = () => {
    ...
    const containerRef = useRef(null); // Створюємо посилання на головний div

    useEffect(() => {
        // Ініціалізуємо ScrollTrigger з інвертованим напрямком шляху
        gsap.to(svgCircle.current, {
            duration: 10, // Загальний час для анімації
            motionPath: {
                path: "#path", // Шлях, по якому рухатиметься коло
                align: "#path",
                autoRotate: true,
                alignOrigin: [0.5, 0.5],
                start: 1, // Початок з кінця шляху (інвертовано)
    ...
    return (
        <div ref={containerRef} className={styles.vector}>
            <svg xmlns="http://www.w3.org/2000/svg" width="330" height="989" viewBox="0 0 350 1100" fill="none">
                ...
                <defs>
                    <linearGradient id="paint0_linear_51_17" x1="-249.487" y1="150.283" x2="-246.852" y2="1176.13"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="white" stopOpacity="0" />
                        <stop offset="0.0777673" stopColor="#4CC3E6" stopOpacity="0.16" />
                        <stop offset="0.320104" stopColor="#35AFD4" stopOpacity="0.401399" />
                    ...
                    <linearGradient id="paint1_linear_51_17" x1="252.916" y1="541.9" x2="232.942" y2="541.9"
                                    gradientUnits="userSpaceOnUse">
